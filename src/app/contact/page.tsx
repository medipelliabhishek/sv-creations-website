    ...
    <>
      <section className="blueprint-grid border-b border-line">
        <div className="mx-auto max-w-6xl px-5 py-16 md:py-20">
          ...
          <h1 className="mt-4 font-display text-4xl font-medium sm:text-5xl">Contact</h1>
      ...
      <section className="mx-auto max-w-6xl px-5 py-16">
        <div className="grid gap-px border border-line bg-line sm:grid-cols-2">
          {contact.phone && (
            <a href={`tel:${contact.phone.replace(/\s/g, "")}`} className="group bg-paper p-8 transition-colors hover:bg-paper-deep/60">
              <Phone className="text-terra" size={22} />
          ...
          {whatsappHref && (
            <a href={whatsappHref} target="_blank" rel="noreferrer" className="group bg-paper p-8 transition-colors hover:bg-paper-deep/60">
              <svg viewBox="0 0 32 32" width="22" height="22" fill="currentColor" className="text-terra" aria-hidden>
        ...
        {contact.instagram && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="mt-8 inline-flex items-center gap-2 text-sm uppercase tracking-[0.15em] text-terra hover:text-terra-deep"
          >
